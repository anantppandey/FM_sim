...
if("TRUE" STREQUAL "TRUE")
  set(sicktoolbox_wrapper_SOURCE_PREFIX /home/anant/FM_sim/src/sicktoolbox_wrapper)
  set(sicktoolbox_wrapper_DEVEL_PREFIX /home/anant/FM_sim/devel)
  ...
  set(sicktoolbox_wrapper_INSTALL_PREFIX /home/anant/FM_sim/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sicktoolbox_wrapper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anant/FM_sim/src/sicktoolbox_wrapper/${idir}'.  ${_report}")
    endif()

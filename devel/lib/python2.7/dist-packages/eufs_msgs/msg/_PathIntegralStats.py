...
"""autogenerated by genpy from eufs_msgs/PathIntegralStats.msg. Do not edit."""
import sys
...
class PathIntegralStats(genpy.Message):
  _md5sum = "9a732ef90ed77e7ea292473d12fb8c41"
  _type = "eufs_msgs/PathIntegralStats"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','eufs_msgs/PathIntegralParams','eufs_msgs/LapStats']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.params is None:
        self.params = eufs_msgs.msg.PathIntegralParams()
      if self.stats is None:
        self.stats = eufs_msgs.msg.LapStats()
    else:
      self.header = std_msgs.msg.Header()
      self.tag = ''
      self.params = eufs_msgs.msg.PathIntegralParams()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_d3I().pack(_x.params.desired_speed, _x.stats.header.seq, _x.stats.header.stamp.secs, _x.stats.header.stamp.nsecs))
      _x = self.stats.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_q5d().pack(_x.stats.lap_number, _x.stats.lap_time, _x.stats.avg_speed, _x.stats.max_speed, _x.stats.max_slip, _x.stats.max_lateral_accel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.params.desired_speed, _x.stats.header.seq, _x.stats.header.stamp.secs, _x.stats.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.stats.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.stats.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 48
      (_x.stats.lap_number, _x.stats.lap_time, _x.stats.avg_speed, _x.stats.max_speed, _x.stats.max_slip, _x.stats.max_lateral_accel,) = _get_struct_q5d().unpack(str[start:end])
      return self

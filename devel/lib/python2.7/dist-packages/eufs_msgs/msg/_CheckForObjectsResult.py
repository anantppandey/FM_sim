...
"""autogenerated by genpy from eufs_msgs/CheckForObjectsResult.msg. Do not edit."""
import sys
...
class CheckForObjectsResult(genpy.Message):
  ...
  _type = "eufs_msgs/CheckForObjectsResult"
...
"""
  ...
  _slot_types = ['int16','eufs_msgs/BoundingBoxes']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bounding_boxes is None:
        self.bounding_boxes = eufs_msgs.msg.BoundingBoxes()
    else:
      self.id = 0
      self.bounding_boxes = eufs_msgs.msg.BoundingBoxes()

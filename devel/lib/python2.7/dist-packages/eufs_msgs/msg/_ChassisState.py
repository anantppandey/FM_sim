...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.steering_commander = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.throttle_commander = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.front_brake_commander = str[start:end].decode('utf-8')
      else:
